 ...
 */
define(["ipuUI","browserTool","jcl"],function(ipuUI, browserTool,Wade) {
	var uiPage = ipuUI.page;
	...
	var Mobile = new function() {
		...
		this.loadPage = function(pageName, param, err){
			...
			uiPage.post(url,{params : params, pageName: pageName, callBack:function(){uiPage.close()}});
		};
		...
		this.back = function(pageName){
			this.backWithCallback(null, pageName);
		};
		/*设置back监听事件*/
